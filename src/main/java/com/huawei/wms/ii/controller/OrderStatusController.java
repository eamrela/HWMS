...
import com.huawei.wms.ii.beans.OrderStatusFacade;
...
public class OrderStatusController implements Serializable {
    ...
    @EJB
    private com.huawei.wms.ii.beans.OrderStatusFacade ejbFacade;
    ...
    public OrderStatus getOrderStatus(java.lang.String id) {
