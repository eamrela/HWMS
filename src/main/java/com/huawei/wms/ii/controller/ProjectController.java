...
import com.huawei.wms.ii.beans.ProjectFacade;
...
public class ProjectController implements Serializable {
    ...
    @EJB
    private com.huawei.wms.ii.beans.ProjectFacade ejbFacade;
    ...
    @FacesConverter("ProjectControllerConverter")
    public static class ProjectControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Project) {
                ...
                return getStringKey(o.getProjectName());
            } else {
